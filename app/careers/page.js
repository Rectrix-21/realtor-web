...
const jobs = [
  {
    ...
    description:
      "Build beautiful, responsive interfaces using React and modern CSS. Collaborate with designers and backend engineers to deliver seamless user experiences.",
  },
  {
    title: "Backend Developer",
    description:
      "Design and implement scalable APIs and services using Node.js, Express, and MongoDB. Ensure data integrity and security for our real estate platform.",
  },
  {
    title: "Sales Executive",
    description:
      "Engage with clients, understand their needs, and help them find their dream properties. Prior real estate sales experience preferred.",
  },
  {
    title: "Marketing Specialist",
    description:
      "Drive digital campaigns, manage social media, and create engaging content to promote our brand and listings.",
  },
  {
    title: "Contractor",
    description:
      "Work with our team to renovate, repair, and maintain properties. Experience in construction or property maintenance required.",
  },
  {
    title: "Designer",
    description:
      "Create stunning visuals and layouts for property listings, marketing materials, and our website. Real estate design experience is a plus.",
  },
];
...
export default function CareersPage() {
  ...
  async function handleSubmit(e) {
    ...
    console.log("Submitting application with form data:", jobForm);
